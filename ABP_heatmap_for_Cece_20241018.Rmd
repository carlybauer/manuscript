...
water_temp <- data%>%
  ...
  geom_point(data = sample_dates, aes(x = MDay, y = 0.1, z = NULL), pch = 25, size = 3, color = "lightgrey", fill = "black")+ #to mark cast dates 
...
make_heat_map(
  ...
  y_units = "Turbidity \n(NTU)",
  output_file = "CTD_turb_2018_2023.jpeg"
)
...
make_heat_map(
  ...
  output_file = "CTD_waterTemp_2018_2023.jpeg"
)
...
make_heat_map(
  ...
  output_file = "CTD_DO_2018_2023.jpeg"
)
...
make_heat_map(
  ...
  custom_heatmap_palette = blue2green2red(60),
  y_units = "pH",
  output_file = "CTD_pH_2018_2023.jpeg"
)
